...
export default function solicitantes_Confinado() {
        
    const [solicitantesConfinado,setarSolicitantesConfinado] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_confinado').onSnapshot(snapshot=>{
			setarSolicitantesConfinado(snapshot.docs.map(function(doc){
