...
export default function especialar({ navigation }) {
  var nome = 'ESPECIAL + AR';
  return(
    <ScrollView style={styleExterno.container2}> 
      <View style={{alignItems:'center'}}>
        <View style={styleExterno.boxsegundatela}>   
          <Image style={styleExterno.iconesmeio} source={require('E:/DANKI/approve/icones/especialar.png')}/>
      ...
      <View style={{flexDirection:'column',marginTop:'19%'}}>
        ...
        <View style={{marginLeft:'10%',alignItems:'center',justifyContent:'center',flexDirection:'row',flexWrap:'wrap'}}>
          ...
          {/* BOTÃO 1*/}
          <TouchableOpacity 
            onPress={() => navigation.navigate('Solicitantes HPE Especial')}
            style={{ 
              textAlign:'center',
              marginRight:'15%',
              borderRadius:50,
        ...
        <View style={{marginLeft:'10%',alignItems:'center',justifyContent:'center',flexDirection:'row',flexWrap:'wrap',marginTop:'10%'}}>
          ...
          {/* BOTÃO 2*/}
          <TouchableOpacity 
            onPress={() => navigation.navigate('aprovadoresEspecial')}
            style={{ 
              textAlign:'center',
              borderRadius:50,
              marginRight:'15%',
