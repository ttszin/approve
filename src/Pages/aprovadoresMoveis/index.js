...
export default function aprovadoresMoveis() {

    const [aprovadoresMoveis,setarAprovadoresMoveis] = useState([]);

    useEffect(()=>{
		db.collection('aprovadores_moveis').onSnapshot(snapshot=>{
			setarAprovadoresMoveis(snapshot.docs.map(function(doc){
