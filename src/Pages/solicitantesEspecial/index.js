...
export default function solicitantes_Especial() {
        
    const [solicitantesEspecial,setarSolicitantesEspecial] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_especial').onSnapshot(snapshot=>{
			setarSolicitantesEspecial(snapshot.docs.map(function(doc){
