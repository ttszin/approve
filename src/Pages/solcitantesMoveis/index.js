...
export default function solicitantes_Moveis() {
        
    const [solicitantesMoveis,setarSolicitantesMoveis] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_moveis').onSnapshot(snapshot=>{
			setarSolicitantesMoveis(snapshot.docs.map(function(doc){
