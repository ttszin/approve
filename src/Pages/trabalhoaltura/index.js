...
export default function trabalhoaltura({ navigation }) {
  var nome = 'TRABALHO EM ALTURA';
  return(
    <ScrollView style={styleExterno.container2}> 
      <View style={{alignItems:'center'}}>
        <View style={styleExterno.boxsegundatela}>   
          <Image style={styleExterno.iconesmeio} source={require('E:/DANKI/approve/icones/icamento.png')}/>
