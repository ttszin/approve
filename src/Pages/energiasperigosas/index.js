...
export default function energiasperigosas({ navigation }) {
  var nome = 'ENERGIAS PERIGOSAS';
  return(
    <ScrollView style={styleExterno.container2}> 
      <View style={{alignItems:'center'}}>
        <View style={styleExterno.boxsegundatela}>   
          <Image style={styleExterno.iconesmeio} source={require('E:/DANKI/approve/icones/energiasperigosas.png')}/>
        ...
        <Text 
          style ={{
            ...
            marginRight:'2%',
            textAlign:'center',
          }}>O QUE VOCÊ PROCURA PARA {nome} ? </Text> 
        <Text
          style ={{
            fontFamily:'monospace', 
            fontSize:17,
