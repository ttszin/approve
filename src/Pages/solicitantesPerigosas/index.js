...
export default function solicitantesPerigosas() {
        
    const [solicitantesPerigosas,setarSolicitantesPerigosas] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_energiasperigosas').onSnapshot(snapshot=>{
			setarSolicitantesPerigosas(snapshot.docs.map(function(doc){
