...
export default function aprovadoresIcamento() {

    const [aprovadoresIcamento,setarAprovadoresIcamento] = useState([]);

    useEffect(()=>{
		db.collection('aprovadores_icamento').onSnapshot(snapshot=>{
			setarAprovadoresIcamento(snapshot.docs.map(function(doc){
