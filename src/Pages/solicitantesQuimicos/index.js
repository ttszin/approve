...
export default function solicitantesQuimicos() {
        
    const [solicitantesQuimicos,setarSolicitantesQuimicos] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_quimicos').onSnapshot(snapshot=>{
			setarSolicitantesQuimicos(snapshot.docs.map(function(doc){
