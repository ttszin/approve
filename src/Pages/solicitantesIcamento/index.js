...
export default function solicitantes_Icamento() {
        
    const [solicitantesIcamento,setarSolicitantesIcamento] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_icamento').onSnapshot(snapshot=>{
			setarSolicitantesIcamento(snapshot.docs.map(function(doc){
