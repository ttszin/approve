...
export default function solicitantesSegProc() {
        
    const [solicitantesSegProc,setarSolicitantesSegProc] = useState([]);

    useEffect(()=>{
		db.collection('solicitantes_quente').onSnapshot(snapshot=>{
			setarSolicitantesSegProc(snapshot.docs.map(function(doc){
